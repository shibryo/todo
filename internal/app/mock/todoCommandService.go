...
func (m *MockTodoComandService) CreateTodoCommand(todo *domain.Todo) error {
	m.ctrl.T.Helper()
...
func (mr *MockTodoComandServiceMockRecorder) CreateTodoCommand(todo interface{}) *gomock.Call {
...
func (m *MockTodoComandService) DeleteTodoCommand(todo *domain.Todo) error {
	m.ctrl.T.Helper()
...
func (mr *MockTodoComandServiceMockRecorder) DeleteTodoCommand(todo interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockTodoComandService) FindByIdCommand(id uint64) (*domain.Todo, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindByIdCommand", id)
	ret0, _ := ret[0].(*domain.Todo)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockTodoComandServiceMockRecorder) FindByIdCommand(id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindByIdCommand", reflect.TypeOf((*MockTodoComandService)(nil).FindByIdCommand), id)
}

// UpdateTodoCommand mocks base method.
func (m *MockTodoComandService) UpdateTodoCommand(todo *domain.Todo) error {
	m.ctrl.T.Helper()
...
func (mr *MockTodoComandServiceMockRecorder) UpdateTodoCommand(todo interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
